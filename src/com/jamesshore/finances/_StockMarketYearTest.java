...
public class _StockMarketYearTest {
	...
	@Test
	public void nextYearStartingValuesMatchesThisYearEndingBalances() {
	...
	private StockMarketYear newYear() {
		StockMarketYear thisYear = new StockMarketYear(STARTING_BALANCE, STARTING_PRINCIPAL, INTEREST_RATE, CAPITAL_GAINS_TAX_RATE);
		return thisYear;
	}
}
